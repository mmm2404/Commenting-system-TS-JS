window.addEventListener('DOMContentLoaded', () => {
    localStorage.clear();
    const commentNumber: HTMLElement | null = document.getElementById('comment-number');
    ...
    // document.getElementById('comment-number').innerHTML = localStorage.getItem('count');
    ...
    function changeIcon(): void {
        ...
        //находим наши узлы
        const btn: HTMLButtonElement | null = document.querySelector(".arrow");
        const iconPath: Element | null = document.querySelector(".path");
    ...
    const countDidgits: HTMLElement | null = document.getElementById('count');
    const error: HTMLElement | null = document.getElementById("error-msg");
    const errorMobile: HTMLElement | null = document.getElementById("error-msg__mobile")
    const send: HTMLElement | null = document.querySelector(".send-btn");
if(text !== null)
    ...
    const images: string[] = ['./images/avatar_alex.png', './images/avatar_max.png', './images/avatar_junebox.png'];
       const form: HTMLElement | null = document.getElementById(".commentsReplies");
    // const form: HTMLFormElement = document.forms.commentsReplies;
...
if(form !== null)
    ...
    function post(event: any) {
        ...
        if (clicked.matches('.send-btn')) {
            ...
            let name: any = (document.getElementById("name") as HTMLFormElement).value;
            let text: any = (document.getElementById('text') as HTMLFormElement).value;
            let avatar: HTMLElement | null = document.getElementById("avatar");
            ...
            (document.getElementById('text') as HTMLFormElement).value = "";
            (document.getElementById('avatar-img') as HTMLFormElement).src = images[1];
            ...
            let chosen: Element | null = document.querySelector(".massage");
        ...
        <button class='repTxt' type='button'>Ответить</button></div></div></ul>`);
            ...
            let nameWeRepliedTo = (document.getElementById("name-now") as HTMLElement).innerText;

            let text: any = clicked.previousElementSibling.value;
            let nameInput = document.getElementById("nameRep");
            let nameReplied: any = (document.getElementById("nameRep") as HTMLInputElement).value;
            ...
            let avatar = (document.getElementById('avatar-img') as HTMLImageElement |null)
            if (avatar !== null)
            avatar.src = images[1];
        ...
        let favoriteBtn: HTMLButtonElement | null = document.querySelector(".favorite")
        if (favoriteBtn !== null)
        ...
        let button: HTMLElement | null = document.getElementById('comment-page');
        if(button !== null)
        button.onclick = function () {
            let massageList: NodeListOf<HTMLFieldSetElement> = document.querySelectorAll('fieldset');
            let massages: HTMLFieldSetElement[] = Array.from(massageList);
        ...
        function timeConvert(UNIX_timestamp: any) {
